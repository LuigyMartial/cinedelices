    ...
    class Recipe extends Model {
        ...
        static associate(models) {
            ...
            Recipe.belongsTo(models.User, {
                foreignKey: 'user_id',
                as: 'author', // alias, permet de faire les 'include' sans avoir à importer le deuxième modèle. // On choisi la valeur pour cet alias, mais en pratique, répondre à la questio: "quand je requête un liste, je veux pouvoir récupérer ses..."
                onDelete: 'CASCADE'
            });
